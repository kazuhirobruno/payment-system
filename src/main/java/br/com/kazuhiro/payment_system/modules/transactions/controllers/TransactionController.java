...
public class TransactionController {
  ...
  @ApiResponse(responseCode = "404", description = "Usuário destino não foi encontrado no sistema.", content = @Content)
  @ApiResponse(responseCode = "403", description = "Operação recusada. O usuário está inativo/deletado no sistema.", content = @Content)

...
public class AuthUserController {
  ...
  @PostMapping("/auth")
  @Operation(summary = "Autenticar usuário", description = "Valida as credenciais do usuário (e-mail e senha) e retorna um token JWT válido.")
  ...
  @ApiResponse(responseCode = "401", description = "Credenciais inválidas ou usuário não autorizado.", content = @Content(schema = @Schema(implementation = String.class)))
